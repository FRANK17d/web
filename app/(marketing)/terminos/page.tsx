...
export const metadata: Metadata = {
  ...
  description:
    'Términos base de uso de toke+: condiciones generales para clientes, profesionales y visitantes de la plataforma.',
  openGraph: {
    title: 'Términos y condiciones | toke+',
...
const terms = [
  {
    ...
    icon: FileText,
    text: 'toke+ permite que clientes soliciten servicios del hogar y que profesionales puedan recibir oportunidades de trabajo según disponibilidad, categoría y zona de atención.',
  },
  {
    title: 'Usuarios y responsabilidades',
    icon: Handshake,
    text: 'Cada usuario debe brindar información real, mantener actualizados sus datos y usar la plataforma de forma respetuosa, lícita y coherente con el servicio solicitado.',
  },
  {
    title: 'Profesionales de servicio',
    icon: BadgeCheck,
    text: 'Los profesionales son responsables de la calidad, puntualidad, presupuesto y ejecución del trabajo que acuerden con el cliente, sin perjuicio de los controles y procesos internos de toke+.',
  },
  {
  ...
  return (
    <>
      <MarketingSubpageHero
        eyebrow="Legal"
        title="Términos y condiciones"
        description="Estas condiciones describen las reglas base para usar toke+. El texto debe validarse con asesoría legal antes de publicarse como contrato definitivo."
      />
      ...
      <section className="bg-neutral-50 py-20 lg:py-28">
        <div className="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-[0.85fr_1.15fr] lg:px-8">
          ...
          <div className="space-y-4">
            <PolicyRow title="Solicitudes y presupuestos" text="El cliente debe describir su necesidad con la mayor claridad posible. Todo presupuesto, alcance, horario y condición del servicio debe quedar coordinado entre las partes." />
            <PolicyRow title="Pagos y cancelaciones" text="Cuando la plataforma habilite pagos o reservas, las reglas específicas de cobro, reembolso o cancelación se informarán antes de confirmar la operación." />
            ...
            <PolicyRow title="Cambios en los términos" text="toke+ puede actualizar estas condiciones para reflejar cambios del servicio, mejoras operativas o exigencias normativas." />
          </div>
        </div>
      </section>
