...
const enlaces = [
  ...
  { label: 'Centro de Ayuda / Preguntas frecuentes', href: '/ayuda' },
]
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-14 lg:py-16">
            ...
            <ul className="mt-5 space-y-3">
              {enlaces.map((link) => (
                <li key={link.label}>
                  <Link
                    href={link.href}
                    className="text-sm text-neutral-400 underline decoration-neutral-700 underline-offset-4 transition-colors duration-200 hover:text-white hover:decoration-white"
                  >
                    {link.label}
                  </Link>
                </li>
            ...
            <div className="mt-5 flex items-center gap-2.5">
              {socials.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className={`flex h-9 w-9 items-center justify-center rounded-full ${s.bg} text-white transition-transform duration-200 hover:scale-110`}
                >
                  {s.icon}
                </a>
              ))}
        ...
        <div className="mt-12 border-t border-white/10 pt-8 text-center">
          <p className="text-xs text-neutral-500">
            ...
            <span className="font-semibold text-neutral-400">toke+</span>{' '}
