...
const team = [
  {
    ...
    image: '/Edgar-Insfran-compress.jpg',
  },
  {
    name: 'Edgar Cabral',
    role: 'CTO',
    detail: 'Tecnologia, analisis y diseno integral de software.',
    image: '/Edgar-Cabral-compress.jpg',
  },
  {
...
export function TeamSection() {
  return (
    <section className="relative overflow-hidden bg-white py-20 lg:py-28">
      ...
      <div className="pointer-events-none absolute left-1/2 top-20 h-72 w-72 -translate-x-1/2 rounded-full bg-[#EE7070]/[0.06] blur-3xl" />
        ...
        <div className="mt-14 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {team.map((member, index) => (
            <article key={`${member.name}-${index}`} className="text-center">
              <div
                className="group/team relative mx-auto h-[310px] max-w-[230px] cursor-none overflow-hidden rounded-[1.75rem] bg-gradient-to-b from-[#FFF0EE] to-white motion-reduce:cursor-auto"
              ...
              >
                ...
                />
                <div className="absolute inset-0 z-30 rounded-[1.75rem] ring-1 ring-inset ring-[#D94F4F]/0 transition group-hover/team:ring-[#D94F4F]/20" />
                <div
                  className="pointer-events-none absolute z-40 flex h-20 w-20 -translate-x-1/2 -translate-y-1/2 scale-90 items-center justify-center rounded-full bg-[#D94F4F] text-center text-[10px] font-black uppercase tracking-[0.14em] text-white opacity-0 shadow-2xl shadow-[#D94F4F]/30 transition-[opacity,transform] duration-75 group-hover/team:scale-100 group-hover/team:opacity-100 motion-reduce:hidden"
                  style={{
              ...
              <p className="mt-1 text-xs font-black uppercase tracking-[0.16em] text-[#D94F4F]">
                {member.role}
              </p>
